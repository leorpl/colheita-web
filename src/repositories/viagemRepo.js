        ...
        `INSERT INTO viagem (
          ...
          impureza_kg, ardidos_kg, queimados_kg, avariados_kg, esverdiados_kg, quebrados_kg,
           peso_limpo_seco_kg, sacas,
            ...
            custo_frete_sacas, custo_secagem_sacas, custo_silo_sacas, custo_terceiros_sacas, custo_outros_sacas,
  ...
  update(id, data, { user_id } = {}) {
    db.prepare(
      `UPDATE viagem SET
          ...
          custo_frete_sacas=@custo_frete_sacas, custo_secagem_sacas=@custo_secagem_sacas, custo_silo_sacas=@custo_silo_sacas,
          custo_terceiros_sacas=@custo_terceiros_sacas, custo_outros_sacas=@custo_outros_sacas,
